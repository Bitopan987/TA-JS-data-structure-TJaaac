...
console.log(got.houses[0].people.length, "stark");

// 13. Log the size of people in Lannisters house
console.log(got.houses[1].people.length, "lannis");
